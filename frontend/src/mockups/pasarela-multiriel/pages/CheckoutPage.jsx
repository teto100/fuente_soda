  ...
  const handleSubmit = (e) => {
    ...
    if (selectedPayment === 'wallet' && selectedWallet === 'plin') {
      ...
      setTimeout(() => {
        ...
        setShowSuccess(true)
        setTimeout(() => {
          navigate('/pasarela-multiriel/success')
        }, 2000)
      }, 5000)
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center space-x-3 text-xs">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-primary">Pago 100% Seguro</span>
                    </div>
                    <div className="flex items-center space-x-1">
              ...
              {showAllPayments ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div onClick={() => handlePaymentSelect('card')} className={`p-4 border-2 rounded-xl cursor-pointer transition-all hover:shadow-md ${selectedPayment === 'card' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}>
                      <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-xs text-primary mt-1 animate-pulse bg-blue-100 px-2 py-1 rounded-full font-semibold">+20 puntos</span>
                      </div>
                    </div>
                    ...
                    <div onClick={() => handlePaymentSelect('transfer')} className={`p-4 border-2 rounded-xl cursor-pointer transition-all hover:shadow-md ${selectedPayment === 'transfer' ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}>
                      <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-xs text-primary mt-1 animate-pulse bg-blue-100 px-2 py-1 rounded-full font-semibold">+10 puntos</span>
                      </div>
                    </div>
                    <div className="p-4 border-2 border-gray-200 rounded-xl opacity-50">
                      <div className="flex flex-col items-center text-center">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setShowAllPayments(true)} className="flex items-center space-x-1 text-primary hover:text-primary">
                  ...
                  <div className="p-3 border-2 border-blue-500 bg-blue-50 rounded-xl">
                    <div className="flex items-center space-x-3">
                      {selectedPayment === 'card' && <CreditCard className="w-6 h-6 text-primary" />}
                      ...
                      {selectedPayment === 'transfer' && <Building className="w-6 h-6 text-primary" />}
                      <div>
